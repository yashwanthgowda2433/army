...
<div class="container">
<form enctype="multipart/form-data" method="post" action="<?php echo base_url('student/add/'.$id);?>">  
        ...
        <div class="col-sm-6">
            <div class="row heading-row">
				...
				<div class="col-sm-7 mt-1">
			        <div class="form-control">
					    <input typt="text" class="form-input" name="cadetno" style="width:100%;"/>
			        </div>
		        </div>
	        </div>
			<div class="row heading-row">
			...
			<div class="row heading-row">
				...
				<div class="col-sm-7 mt-1">
			        <div class="form-control">
					    <input typt="text" class="form-input" name="house" style="width:100%;"/>
			        </div>
		        </div>
	        </div>
			<div class="row heading-row">
				...
				<div class="col-sm-7 mt-1">
			        <div class="form-control">
					    <input typt="text" class="form-input" name="dob" style="width:100%;"/>
			        </div>
		        </div>
	        </div>
			<div class="row heading-row">
				...
				<div class="col-sm-7 mt-1">
			        <div class="form-control">
					    <input typt="text" class="form-input" name="admn" style="width:100%;"/>
			        </div>
		        </div>
	        </div>
			<div class="row heading-row">
				...
				<div class="col-sm-7 mt-1">
			        <div class="form-control">
					    <input typt="text" class="form-input" name="class_joined" style="width:100%;"/>
			        </div>
		        </div>
	        </div>
			<div class="row heading-row">
				...
				<div class="col-sm-7 mt-1">
			        <div class="form-control">
					    <input typt="text" class="form-input" name="discharge" style="width:100%;"/>
			        </div>
		        </div>
	        </div>
			<div class="row heading-row">
				...
				<div class="col-sm-7 mt-1">
			        <div class="form-control">
					    <input typt="text" class="form-input" name="class_left" style="width:100%;"/>
			        </div>
		        </div>
	        </div>
			<div class="row heading-row">
		        <div class="col-sm-4 mt-2">
			        <div class="form-control">
				        <label class="form-label">NDA Joined :</label>
			        </div>
		        </div>
				<div class="col-sm-7 mt-1">
			        <div class="form-control">
					    <input typt="text" class="form-input" name="nda" style="width:100%;"/>
			        </div>
		        </div>
	        </div>
