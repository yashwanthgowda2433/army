...
<div class="container">
<form method="post" action="<?php echo base_url('student/submit_query/'.$id);?>">
	<div class="row heading-row">
		<div class="col-sm-10 text-center mx-auto mt-5">
			...
			<h2 style='font-family: "Tw Cen MT";color:#000;'>Query Request</h2>
		</div>
	</div>
    <div class="row">
        <div class="col-sm-6" style="margin:auto;">
            <div class="row heading-row">
				...
				<div class="col-sm-7 mt-1">
			        <div class="form-control">
					    <input typt="text" class="form-input" name="cadetno" value="<?php echo $id;?>" style="width:100%;" disabled/>
			        </div>
		        </div>
	        </div>
			<div class="row heading-row">
				...
				<div class="col-sm-7 mt-1">
			        <div class="form-control">
					    <textarea class="form-input" name="query" style="width:100%;" rows="5" ></textarea>
			        </div>
		        </div>
	        </div>
	...
	<div class="row mb-5 mt-2">
		...
		<div class="col-sm-12">
		    <div class="row" style="width:max-content;display:flex;flex-wrap: unset;margin-left: 0px;margin:auto;">
				...
				<a class="btn btn-dark m-2" href="<?php echo base_url('student/view_querires/'.$id);?>" id="exit" style="width:220px;">View Queries</a>
			</div>
		</div>
	</div>
</form>
